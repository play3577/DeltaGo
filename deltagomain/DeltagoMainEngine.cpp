//----------------------------------------------------------------------------
/** @file DeltagoMainEngine.cpp
    See DeltagoMainEngine.h */
//----------------------------------------------------------------------------
...
DeltagoMainEngine::DeltagoMainEngine(int fixedBoardSize, const char* programPath,
                                 const string& player)
    : GoGtpEngine(fixedBoardSize, programPath),
      m_extraCommands(Board()),
      m_safetyCommands(Board())
{
    Register("fuegotest_param", &DeltagoMainEngine::CmdParam, this);
    m_extraCommands.Register(*this);
    m_safetyCommands.Register(*this);
    SetPlayer(player);
}

DeltagoMainEngine::~DeltagoMainEngine()
{ }

void DeltagoMainEngine::CmdAnalyzeCommands(GtpCommand& cmd)
{
...
/** Player selection.
    ...
    Parameters:
    @arg @c player Player id as in DeltagoMainEngine::SetPlayer */
void DeltagoMainEngine::CmdParam(GtpCommand& cmd)
{
...
void DeltagoMainEngine::CmdVersion(GtpCommand& cmd)
{
#ifdef VERSION
...
GoPlayer* DeltagoMainEngine::CreatePlayer(const string& playerId)
{
...
void DeltagoMainEngine::SetPlayer(const string& playerId)
{
